...
function Logo() {
    return (<div className="font-serif text-4xl cursor-pointer">
...
function Profile() {
    return (<div className="text-white p-4 grid grid-flow-col justify-evenly text-center shadow-xl outline-slate-950 bg-slate-500 rounded-lg cursor-pointer hover:-translate-y-0.5">
