...
function HeroCards() {
    return (
        <div className="flex justify-center items-start gap-4">
            ...
            <div className=" p-4 rounded-3xl grid gap-2 bg-white shadow-xl shadow-[--fourth] h-auto max-w-60 hover:shadow-none SlowHover">
            ...
            <div className=" p-4 rounded-3xl grid gap-2 bg-white shadow-xl shadow-[--fourth] h-auto hover:shadow-none SlowHover">
...
function CollectionCard() {
    return (
        <div className="relative w-full">
            <div className="rounded-2xl absolute SlowHover top-10 right-10 collectionCard grid place-content-center"></div>
            <div className="rounded-2xl absolute SlowHover top-5 right-5 collectionCard grid place-content-center"></div>
            <div className="rounded-2xl absolute SlowHover top-1 right-0 collectionCard grid place-content-center"></div>
        </div>
    )
}
